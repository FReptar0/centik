...
| 06-04-01 | 04 | 3 | TXN-04, TXN-05, TXN-10 | build + visual | `npm run build && npm run lint` | N/A | ⬜ pending |

---

## Wave 0 Requirements

- [ ] `src/app/configuracion/actions.test.ts` — Category Server Action tests
- [ ] `src/app/movimientos/actions.test.ts` — Transaction Server Action tests
- [ ] `src/components/transactions/TransactionForm.test.tsx` — Quick-add form tests
- [ ] `src/components/transactions/TransactionList.test.tsx` — List + filter tests
